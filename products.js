...
const SHOP = {
  ...
  social: {
    facebook_page: "https://www.facebook.com/share/1EXW8gFW5x/",    // full Facebook page URL বা username
...
const PRODUCTS = [
  ...
  // ---------- আরও নতুন গাছ ----------
  { cat: "indoor", name_bn: "পোথোস (হার্ডি)", name_en: "Pothos (Hardy)",
    price: 180, img: "img/money-plant.jpg", video: "", available: true,
    desc_bn: "বেশি যত্ন ছাড়াই বেড়ে ওঠে। শোবার ঘর, অফিস বা টেবিলের জন্য উপযুক্ত।" },

  { cat: "indoor", name_bn: "ব্রায়ান্থাম", name_en: "Bryophyllum",
    price: 220, img: "img/aglaonema.jpg", video: "", available: true,
    desc_bn: "পাতার রঙিন ছাপ আর সহজ যত্নে ঘর সাজায়। ছোট টবেও ভালো লাগে।" },

  { cat: "flower", name_bn: "শিউলি", name_en: "Shiulie",
    price: 230, img: "img/joba.jpg", video: "", available: true,
    desc_bn: "সাদা-হলুদ রঙের মনোরম ফুল, বারান্দা বা বাগানে দারুণ দেখায়।" },

  { cat: "flower", name_bn: "জার্মান গোলাপ", name_en: "German Rose",
    price: 260, img: "img/golap.jpg", video: "", available: true,
    desc_bn: "রঙিন ফুল আর সুন্দর গন্ধে ঘর-উঠান উজ্জ্বল করে।" },

  { cat: "fruit", name_bn: "আমলকি", name_en: "Amloki",
    price: 220, img: "img/lebu.jpg", video: "", available: true,
    desc_bn: "ঔষধি গুণে ভরা ছোট্ট ফল। টব বা উঠানে বাড়ানো সহজ।" },

  { cat: "fruit", name_bn: "বড় পেয়ারা", name_en: "Large Guava",
    price: 280, img: "img/peyara.jpg", video: "", available: true,
    desc_bn: "বেশি মিষ্টি ও বড় ফল দেওয়ার জন্য সহজে বেছে নেওয়া যায়।" },
];
